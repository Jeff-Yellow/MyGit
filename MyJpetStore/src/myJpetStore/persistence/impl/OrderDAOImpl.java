...
public class OrderDAOImpl implements OrderDAO {
	...
	public List<Order> getOrdersByUsername(String username) {
		 List<Order> result = new ArrayList<Order> ();
	        try {
	            ...
	            PreparedStatement statement = conn.prepareStatement(GetOrdersByUsername);
	            statement.setString(1, username);
	            ResultSet resultSet = statement.executeQuery(GetOrdersByUsername);
	...
	public Order getOrder(int orderId) {
		...
		try {
            Connection conn = DBUtil.getConnection();
            PreparedStatement statement = conn.prepareStatement(GetOrderString);
            statement.setInt(1, orderId);
            ResultSet resultSet = statement.executeQuery(GetOrderString);
	...
	public void insertOrderStatus(Order order) {
		try {
			Connection connection = DBUtil.getConnection();
			PreparedStatement pStatement = connection
                    .prepareStatement(InsertOrderStatus);
			pStatement.setInt(1, order.getOrderId());
